...
public class MiniMaxOpeningImproved {
   ...
   static int num = 0;
    ...
    //static estmation function that counts the number of mills instead of pieces
    public static int StaticEst (char [] board, int depth){
 
       int blackMill = 0;
       int whiteMill = 0;
      //loop through the board and count the # of white and black mills
   ...
   public static char [] BoardOutput(ArrayList<char[]> board) {
    ...
    try {
     FileWriter write = new FileWriter("board11.txt");
     write.write(output);
     write.close();
     } catch (IOException e) {
...
// remove a black (that is not in mill), when white pieces are in mill 
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            while(r.hasNextLine()){
                ...
                System.out.println( MiniMax(b, 2));
